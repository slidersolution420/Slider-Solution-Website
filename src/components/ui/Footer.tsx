      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 text-center sm:grid-cols-2 sm:text-start md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-gray-500">{t('tagline')}</p>
            <div>
              ...
              <div className="flex justify-center gap-3 sm:justify-start">
                {settings.facebook_url && (
                  <a
                    ...
                    aria-label="Facebook"
                    className="flex size-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-gray-400 transition-colors hover:border-white/20 hover:text-white"
                  >
